  ...
  return (
    <div>
      <Link
        ...
        font-semibold hover:bg-colors-light hover:text-colors-dark border-2 border-solid
        border-transparent hover:border-colors-dark hover:dark:border-colors-primary dark:bg-colors-light dark:text-colors-dark'
        download={download}
      >
        {text}
